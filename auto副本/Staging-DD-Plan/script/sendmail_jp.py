...
qa_host="http://172.19.8.161:8088/"
qa_path="datadeck_jp_Plan/"
qa_file="DATADECK_JP_TestReport_Plan_"
subject = 'datadeck interface result'

jpfile_name='/data/www/qa/logs/datadeck_jp_Plan/jp_datadeck_Plan.txt'
jpfile_error_name='/data/www/qa/logs/datadeck_jp_Plan/errlog/jp_datadeck_Plan_errlog.txt'
DIR='/data/www/qa/datadeck_jp_Plan/'
