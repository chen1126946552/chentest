...
qa_path="datadeck_DataSource/AmazonRDSforMySQL/"
qa_file="DATADECK_JP_TestReport_"
subject = 'datadeck interface result'

jpfile_name='/data/www/qa/logs/datadeck_DataSource/AmazonRDSforMySQL/jp_datadeck_interface.txt'
jpfile_error_name='/data/www/qa/logs/datadeck_DataSource/AmazonRDSforMySQL/errlog/jp_datadeck_interface_errlog.txt'
DIR='/data/www/qa/datadeck_DataSource/AmazonRDSforMySQL/'
...
slacktext =  '{0}\n{1} 日本区DDv2_DS_Amazon RDS for MySQL_AUTO_检查失败：\nzhen.qin\n{2}\n{3}'.format(towho, now_date, failmsg, lines)
