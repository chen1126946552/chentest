...
qa_path="datadeck_DataSource/ExcelCSV/"
qa_file="DATADECK_JP_TestReport_"
subject = 'datadeck interface result'

jpfile_name='/data/www/qa/logs/datadeck_DataSource/ExcelCSV/jp_datadeck_interface.txt'
jpfile_error_name='/data/www/qa/logs/datadeck_DataSource/ExcelCSV/errlog/jp_datadeck_interface_errlog.txt'
DIR='/data/www/qa/datadeck_DataSource/ExcelCSV/'
